package org.springyoung.file.channel;
...
import static org.springyoung.file.packet.enums.TftpOpcode.RRQ;
import static org.springyoung.file.packet.enums.TftpOpcode.WRQ;


/**
 * @ClassName TftpServerChannel
 * @Description TODO
 * @Author 小温
...
public class TftpServerChannel extends AbstractNioMessageChannel implements ServerChannel {
    ...
    protected int doReadMessages(List<Object> packetList) throws Exception {
        ...
        try {
            ...
            try {
                tftpPacket = TftpPacketUtil.create(data);
            } catch (Exception exp) {
