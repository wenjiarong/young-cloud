package org.springyoung.demo.service.impl;
...
import org.springyoung.demo.mapper.TradeLogMapper;
...
public class TradeLogServiceImpl extends ServiceImpl<TradeLogMapper, TradeLog> implements ITradeLogService {
    ...
    public boolean orderAndPay(TradeLog tradeLog) {
        ...
        this.rocketMQTemplate.sendMessageInTransaction(
                RocketMqConstant.PAY_PRODUCER_GROUP, // 事务消息分组，组名
                RocketMqConstant.PAY_TOPIC, // 事务消息topic
